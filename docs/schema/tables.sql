...
CREATE TABLE IF NOT EXISTS `resource` (
  `id` char(64) NOT NULL COMMENT '全局唯一Id,直接使用云商自己的Id',
  ...
  `expire_at` bigint(13) NOT NULL COMMENT '过期时间',
  `catehory` varchar(64) NOT NULL COMMENT '种类',
  `type` varchar(120) NOT NULL COMMENT '规格',
  `name` varchar(255) NOT NULL COMMENT '名称',
  `describetion` varchar(255) NOT NULL COMMENT '描述',
  ...
  `sync_account` varchar(255) DEFAULT NULL COMMENT '同步账号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='资源基础信息,所有资源的公共信息,用于全局解锁';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT '资源标签';
...
CREATE TABLE IF NOT EXISTS `resource_host` (
  ...
  `image_id` char(64) CHARACTER SET latin1 DEFAULT NULL COMMENT '镜像Id',
  ...
  `key_pair_name` varchar(255) CHARACTER SET latin1 DEFAULT NULL COMMENT 'ssh key关联Id',
  `security_groups` varchar(255) CHARACTER SET latin1 DEFAULT NULL COMMENT '安全组Id列表',
  PRIMARY KEY (`resource_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT '服务器主句信息';
