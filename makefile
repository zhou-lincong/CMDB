...
PKG := "github.com/zhou-lincong/CMDB"
IMAGE_PREFIX := "github.com/zhou-lincong/CMDB"
...
######  make pb windows路径问题
#	cp -r /e/ruanjian/gopath/pkg/mod/github.com/infraboard/mcube@v1.8.6/pb/* common/pb/github.com/infraboard/mcube/pb
...
##	1.先go mod tidy 
##	2.make pb + cp -r /d/安装/gopath/pkg/mod/github.com/infraboard/mcube@v1.8.6/pb/* common/pb/github.com/infraboard/mcube/pb
##	3.rm -rf common/pb/github.com/infraboard/mcube/pb/*/*.go
##	4.make gen
##  5.protocol/http.go PathPrefix()补充"/%s/api"
